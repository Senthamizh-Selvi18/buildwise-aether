      ...
      <div className="studio-content-width" style={{ maxWidth: '1200px', paddingBottom: '120px' }}>
        ...
        >
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '16px', marginTop: '12px' }}>
            {[
              { r: "Living Spaces — Architectural Alabaster", hex: "#FFFDF6", d: "Maximizes luminance projection across open framing layout zones." },
              { r: "Sleeping Quarters — Slate Velvet", hex: "#F3F8FE", d: "Formulated to minimize sensory glare metrics across circadian boundaries." },
              { r: "Culinary Suite — Pure Ivory Ceramic", hex: "#FFFDF9", d: "High cleaning endurance coating optimized for thermal resilience." },
              { r: "Sanitary Enclaves — Satin Vapor", hex: "#F0FBFC", d: "A clear neutral treatment profile maintaining high balance factors." }
            ].map((pt, idx) => (
              <div key={idx} style={{ display: 'flex', gap: '14px', alignItems: 'flex-start', padding: '16px', backgroundColor: 'rgba(8,8,10,0.3)', border: '1px solid rgba(255,255,255,0.01)', borderRadius: '12px' }}>
                <div style={{ width: '24px', height: '24px', backgroundColor: pt.hex, borderRadius: '6px', border: '1px solid rgba(255,255,255,0.1)', flexShrink: 0 }} />
                <div>
